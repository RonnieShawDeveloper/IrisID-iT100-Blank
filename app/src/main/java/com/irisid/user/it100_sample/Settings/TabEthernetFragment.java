...
public class TabEthernetFragment extends Fragment
{
    ...
    {
        rootView = inflater.inflate(R.layout.tab_fragment_ethernet, container, false);
       // final View rootView = inflater.inflate(R.layout.tab_fragment_ethernet_test, container, false);

        //Logger.d("@@TabEthernet  onCreateView");
        ...
        if(isConnected) {
            ...
            showNetworkErrorMsg(getResources().getString(R.string.wait_progress_text));
        }
        ...
        rootLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (heightDiff > 100) { // if more than 100 pixels, its probably a keyboard...
                    ...
                    int padding = 0;
                    int toPosition = 0;
                    if(ip_address_edt.isFocused()){
                        padding = 250;
                        toPosition = 300;
                    }else if(default_gateway_edt.isFocused() || dns2_edt.isFocused()){
                        padding = 320;
                        toPosition = 900;
                    }else {
                        padding = 280;
        ...
        (rootView.findViewById(R.id.btn_save)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ip_radio_group.getCheckedRadioButtonId() == R.id.ip_dhcp_radio) {
                    ...
                    if ( rtnNetworkInfo  == MessageType.ID_RTN_SUCCESS){
    ...
    private void setIPsettingView(boolean isEnable){
       ...
       // Logger.d("@setIPsettingView  isEnable "+ isEnable+" showError "+ showError);
        frameTotal.setVisibility(View.VISIBLE);
    ...
    public void onResume() {
        super.onResume();
        //Logger.d("@@TabEthernet  onResume");
       // getNetorkInfo();
        _ownerHandler.postDelayed(_loading, 3000);
    }
    ...
    private void getNetorkInfo(){
        ...
        if(ip_address_edt.isFocused() || default_gateway_edt.isFocused()
                || dns1_edt.isFocused() || dns2_edt.isFocused() || prefix_len_edt.isFocused())
            return;
    ...
    private boolean isConnectEthernet(){
        boolean conEthernet = false;
        Network[] networks = connectivityManager.getAllNetworks();
        for(int i = 0; i< networks.length; i++){
            Network temp_network = networks[i];
            LinkProperties temp_prop = connectivityManager.getLinkProperties(temp_network);

            if(temp_prop.getInterfaceName().equals("eth0"))
                conEthernet = true;
        }
