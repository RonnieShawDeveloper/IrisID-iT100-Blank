...
public class ItemDetailFragmentWithCard extends Fragment implements View.OnClickListener {
    ...
    private ItemDetailFragmentWithCard.OnItemUpdateListener listener;
...
//        registerCallbackListener();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ItemDetailFragmentWithCard.OnItemUpdateListener) {
            listener = (ItemDetailFragmentWithCard.OnItemUpdateListener) context;
        } else {
    ...
    public static ItemDetailFragmentWithCard newInstance(Item item, int showType) {

        ItemDetailFragmentWithCard fragmentDemo = new ItemDetailFragmentWithCard();
